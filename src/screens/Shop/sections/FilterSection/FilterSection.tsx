...
export const FilterSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full items-center justify-around gap-2.5 px-0 py-[100px] bg-[#faf3ea]">
      <div className="flex w-full max-w-[1334px] items-center justify-between px-4">
