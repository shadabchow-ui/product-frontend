...
const features = [
  {
    ...
    iconClassName: "relative w-[53px] h-[60px] left-1 bg-[100%_100%]",
    title: "High Quality",
    subtitle: "crafted from top materials",
  },
  {
    icon: "/img/vector-65.svg",
    iconClassName: "h-[96.88%] bg-[100%_100%]",
    title: "Warranty Protection",
    subtitle: "Over 2 years",
  },
  {
    icon: "/img/vector-37.svg",
    iconClassName: "absolute w-[100.00%] h-[93.28%] top-[3.36%] left-0",
    title: "Free Shipping",
  ...
  },
  {
    ...
    iconClassName: "absolute w-[88.24%] h-full top-0 left-[5.88%]",
    title: "24 / 7 Support",
...
export const CheckoutFormSection = (): JSX.Element => {
  return (
    <section className="flex w-full relative flex-col items-center justify-around gap-2.5 px-0 py-[100px] bg-[#faf3ea]">
      <div className="flex w-full max-w-[1334px] items-center justify-between relative flex-wrap gap-4 px-4">
