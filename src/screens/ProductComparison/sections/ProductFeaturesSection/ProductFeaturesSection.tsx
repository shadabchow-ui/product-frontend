...
const features = [
  ...
  },
  {
    ...
    iconType: "bg",
    iconClasses: "h-[96.88%] bg-[url(/img/vector-65.svg)] bg-[100%_100%]",
  ...
  },
  {
    ...
    iconType: "img",
    iconClasses: "absolute w-[100.00%] h-[93.28%] top-[3.36%] left-0",
    title: "Free Shipping",
  ...
  },
  {
    ...
    iconType: "img",
    iconClasses: "absolute w-[88.24%] h-full top-0 left-[5.88%]",
    title: "24 / 7 Support",
...
export const ProductFeaturesSection = (): JSX.Element => {
  return (
    <section className="flex w-full relative mt-28 flex-col items-center justify-around gap-2.5 px-0 py-[100px] bg-[#faf3ea]">
        ...
        {features.map((feature, index) => (
          ...
          >
            <div className="relative w-[60px] h-[60px] flex-shrink-0">
              {feature.iconType === "bg" ? (
                <div className={feature.iconClasses} />
              ) : (
                <img
